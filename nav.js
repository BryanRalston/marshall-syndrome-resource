  ...
  var SITE = [
    ...
    },
    {
      folder: 'treatment', title: 'Treatment', pages: [
        ...
        { file: 'treatment/lipus.html', title: 'LIPUS (Low-Intensity Pulsed Ultrasound)', k: 'LIPUS low-intensity pulsed ultrasound disc degeneration ferroptosis GPX4 Nrf2 SOX9 aggrecan MMP NF-kB Wnt Sonic Hedgehog primary cilia mechanotransduction Exogen AccelStim PEMF notochordal cell non-invasive anti-ferroptosis FAK PI3K Akt TIMP senescent clearance' },
        { file: 'treatment/pemf.html', title: 'PEMF Therapy Protocol', k: 'PEMF pulsed electromagnetic field therapy protocol piezoelectric signal replacement TRPV4 TRPC1 ion channel Sirt1 NF-kB MMP SOX9 aggrecan collagen II Wnt ferroptosis GPX autophagy circadian Bmal1 Cry1 Per2 chronotherapy adenosine receptor Orthofix SpinalStim CervicalStim disc degeneration osteoarthritis pain home use device intensity gap growth plate notochordal cell' },
        ...
        { file: 'treatment/multi-organ-protection.html', title: 'Multi-Organ Protection Strategy', k: 'multi-organ triple protection unified disc eye ear retina cochlea NRF2 ferroptosis senescence taurine vitamin D sulforaphane doxycycline senolytic dasatinib quercetin MMP GPX4 selenium deferiprone complement metformin AMPK sulforaphane broccoli sprout COL11A1 shared mechanism convergence' },
        { file: 'treatment/doxycycline-sdd.html', title: 'Sub-Antimicrobial Doxycycline (SDD)', k: 'doxycycline SDD sub-antimicrobial MMP-13 inhibitor Periostat iron chelation anti-ferroptosis Brandt RCT joint space narrowing PAX1 COL11A1 MMP3 axis dual mechanism matrix protection zinc chelation bone microarchitecture metformin synergy 32-64x N-of-1 age 8 tooth discoloration CDC antibiotic resistance' },
        { file: 'treatment/metformin.html', title: 'Metformin: Multi-Cascade Disc Protection', k: 'metformin AMPK NRF2 ferroptosis senescence SASP Wnt modulation Runx2 endplate calcification NP cell protection Chen 2016 UK Biobank MMP NF-kB TREM2 SYK central sensitization microbiome gut-disc axis anti-aging geroprotective B12 doxycycline synergy 7 cascades cheapest generic pennies' },
        { file: 'treatment/glp1-disc-protection.html', title: 'GLP-1 Agonists: Multi-Cascade Disc Protection', k: 'GLP-1 agonist semaglutide liraglutide Wegovy Saxenda GLP-1R nucleus pulposus NP cell anti-ferroptosis GPX4 NRF2 SLC7A11 cartilage protection weight-independent Cell Metabolism 2026 anti-senescence SASP MMP ADAMTS bone osteoblast pediatric 12+ N-of-1 trial 6-7 cascades obesity off-label disc' },
        { file: 'treatment/pediatric-windows.html', title: 'Pediatric Intervention Windows', k: 'pediatric intervention windows notochordal cells dental pulp banking growth plates thyroid screening pubertal hormones growth hormone bone density scoliosis timing critical age-dependent irreversible opportunity' },
        { file: 'treatment/acoustic-optimization.html', title: 'Acoustic & Biomechanical Optimization', k: 'acoustic optimization biomechanical frequency TRPV4 Piezo1 mechanosensitive channel LIPUS focused ultrasound waveform engineering stochastic resonance aquatic therapy swimming disc loading impedance spectroscopy Exogen MELMAK ferroptosis iron influx safe loading dangerous loading strain amplitude duration pulsed stimulation' }
      ]
    },
    {
    ...
    },
    {
      folder: 'future', title: 'Future Therapies', pages: [
        ...
        { file: 'future/clinical-trials-landscape.html', title: 'Clinical Trial Landscape (August 2026)', k: 'clinical trials landscape n-Lorem FDA plausible mechanism ebselen DiscGenics gene therapy registries action items 2026 hearing protection disc regeneration cell banking ASO nano-rare laser Stickler Mesoblast Zevaskyn' },
        ...
        { file: 'future/gene-therapy-update-2025.html', title: 'Gene Therapy: 2025 Deep-Dive (reviewed 2026)', k: 'gene therapy 2025 update Vyjuvek beremagene geperpavec COL7A1 epidermolysis bullosa CRISPR allele-specific base editing prime editing ASO antisense oligonucleotide exon skipping AAV cartilage disc delivery minigene COL11A1 COL6A1 collagen dominant-negative splice variant Zevaskyn' },
        ...
        { file: 'future/epigenetic-reprogramming.html', title: 'Epigenetic Reprogramming of NP Cell Identity', k: 'epigenetic reprogramming OSKM Yamanaka partial reprogramming mRNA chemical small molecule Klotho Wnt antagonist senomorphic senolytic NP cell identity SOX9 FoxA2 brachyury TBXT notochordal CD24 progeria Werner premature senescence SIPS epigenetic clock Horvath GrimAge rejuvenation exosome OKS disc degeneration Loop 3 SASP DNMT3B ferroptosis SLC40A1' },
        ...
        { file: 'future/preprint-drug-repurposing.html', title: 'Preprint: Drug Repurposing Screen', k: 'preprint manuscript paper drug repurposing screen cascade COL11A1 Marshall systematic review metformin doxycycline NAC losartan senolytic MMP ferroptosis SASP' },
        ...
        { file: 'future/lab-outreach-letters.html', title: 'Lab Outreach Letter Templates', k: 'outreach letter template Krystal Biotech UCL Zhou Muntoni Cambridge Snead ASO gene therapy collaboration research contact lab scientist' },
        { file: 'future/cascade-simulation.html', title: 'Cascade Simulation', k: 'cascade simulation model differential equations ODE mathematical senescence SASP MMP ferroptosis drug effect intervention network graph interactive' },
        { file: 'future/biomarker-tracker.html', title: 'Biomarker Tracker Tool', k: 'biomarker tracker tool chart graph hsCRP IL-6 MMP-3 CTX-II ferritin selenium vitamin D pain PedsQL N-of-1 trial monitoring data entry export' },
        { file: 'future/aso-sequence-design.html', title: 'ASO Sequence Design for COL11A1', k: 'ASO antisense oligonucleotide siRNA gapmer allele-specific silencing COL11A1 splice site exon skipping dominant-negative RNase H 2-MOE phosphorothioate sequence design CRISPR gene therapy' },
        { file: 'future/dental-jaw-health.html', title: 'Dental & Jaw Health', k: 'dental jaw TMJ temporomandibular joint COL11A1 Pierre Robin cleft palate retrognathia midface hypoplasia orthodontic braces retention enamel cavity fluoride sealant nightguard anesthesia cervical spine DDR2 MMP-13 condyle cartilage degeneration dental pulp stem cell mouthguard craniofacial' },
        { file: 'future/hearing-audiology.html', title: 'Hearing & Audiology', k: 'hearing audiology sensorineural conductive mixed tectorial membrane COL11A1 audiogram hearing aid cochlear implant FM system tinnitus school 504 IEP speech therapy bone anchored BAHA noise protection ototoxic gene therapy cochlear vestibular risk monitoring schedule amplification frequency lowering Roger remote microphone' },
        { file: 'future/pain-management.html', title: 'Pain Management in Marshall Syndrome', k: 'pain management comprehensive central sensitization nociplastic PNE pain neuroscience education LLLT photobiomodulation TENS aquatic therapy CBT ACT acceptance commitment catastrophizing flare protocol school 504 pacing medication NSAID gabapentin LDN amitriptyline doxycycline opioid alternative pediatric chronic pain hypermobility' },
        { file: 'future/airway-sleep.html', title: 'Airway & Sleep in Marshall Syndrome', k: 'airway sleep apnea OSA obstructive Pierre Robin sequence micrognathia retrognathia glossoptosis CPAP BiPAP polysomnography adenotonsillectomy anesthesia intubation difficult airway cervical spine fiberoptic mandibular distraction rapid maxillary expansion sleep hygiene snoring breathing emergency AHI midface hypoplasia pharyngeal laxity COL11A1 craniofacial melatonin disc rehydration sleep position bedwetting ADHD' },
        { file: 'future/rare-disease-lessons.html', title: 'Lessons from Other Rare Diseases', k: 'rare disease lessons TTR amyloidosis patisiran tafamidis osteogenesis imperfecta OI epidermolysis bullosa EB Vyjuvek Marfan losartan progeria lonafarnib desminopathy vEDS AAT deficiency alpha-1 antitrypsin dominant-negative allele-specific silencing gene therapy regulatory pathway precedent translatable' },
        { file: 'future/ai-drug-discovery.html', title: 'AI-Driven Drug Discovery', k: 'AI artificial intelligence drug discovery computational AlphaFold ColabFold Boltz-2 molecular dynamics PBPK pharmacokinetic digital twin generative chemistry REINVENT DiffDock DiffSBDD network pharmacology TxGNN RareAgent drug repurposing virtual screening COL11A1 collagen XI MMP-13 C-propeptide trimerization chaperone 4-PBA tafamidis PhysiCell COPASI MARTINI ferroptosis senescence cascade in silico clinical trial orphan drug rare disease Atomwise AIMS' },
        { file: 'future/vitreous-therapeutic-target.html', title: 'Vitreous as Therapeutic Target & Biomarker', k: 'vitreous humor therapeutic target biomarker liquid biopsy collagen XI COL11A1 intravitreal injection ASO antisense oligonucleotide gene therapy proteomics mass spectrometry vitrectomy cryoretinopexy retinal detachment beaded vitreous Stickler type 2 complement C3a C5a sustained release Port Delivery System hydrogel vitreous substitute bioengineered fibril nucleation diameter regulation drug delivery eye ocular' },
        { file: 'future/engineered-exosomes.html', title: 'Engineered Exosomes as Disc-Targeted Therapeutics', k: 'engineered exosomes extracellular vesicles EV disc-targeted therapeutics ASO delivery miRNA cargo anti-ferroptosis counter-exosome strategy RBC-derived exosomes surface engineering collagen-binding peptide CD24 TRAIL receptor MSC exosomes intradiscal injection non-viral allele silencing' },
        { file: 'future/matrix-mimetic-biomaterials.html', title: 'Matrix-Mimetic Biomaterials', k: 'matrix mimetic biomaterials collagen XI function replacement fibril diameter regulation recombinant N-propeptide decorin fibromodulin SLRP peptide amphiphile hydrogel injectable disc augmentation tropoelastin coating crystal growth steric barrier nanofiber Stupp lab CollPlant' },
        { file: 'future/electromagnetic-photonic.html', title: 'Electromagnetic & Photonic Interventions', k: 'electromagnetic photonic terahertz THz radiation collagen vibration magnetogenetics ferritin-TRPV4 optogenetics channelrhodopsin cold atmospheric plasma CAP iontophoresis electrochemical pH TENS quantum biology piezoelectric proton tunneling stochastic resonance' }
      ]
    },
    {
      folder: 'living', title: 'Living With Marshall', pages: [
        ...
        { file: 'living/hearing-molecular-mechanisms.html', title: 'Hearing Molecular Mechanisms', k: 'hearing molecular mechanisms COL11A1 tectorial membrane collagen XI cochlea hair cell ferroptosis GPX4 iron NRF2 oxidative stress senescence complement cochlear amplification stereocilia outer hair cell selenium NAC sulforaphane lipid peroxidation Fenton reaction ACSL4 GSH inflammaging LCN2 cAMP MFN2 factor B C1q C3 otoprotection shared defense' },
        ...
        { file: 'living/eye-molecular-mechanisms.html', title: 'Eye Molecular Mechanisms', k: 'eye molecular mechanisms COL11A1 vitreous collagen type XI fibril diameter ferroptosis GPX4 retinal pigment epithelium RPE iron senescence SASP complement alternative pathway drusen Bruch membrane connexin gap junction death wave retinal ganglion cell NRF2 selenium vitamin E lipid peroxidation AMD macular degeneration senolytic UBX1325 DAMP collagen fragment' },
    ...
    },
    {
      folder: 'emerging', title: 'Emerging Research', pages: [
        ...
        { file: 'emerging/chaperone-pharmacology.html', title: 'Chaperone Pharmacology for the Dominant-Negative Protein', k: 'chaperone pharmacology HSP47 SERPINH1 Col003 pirfenidone BMS-986263 rHSP47 FKBP65 cyclophilin B prolyl isomerase ERAD ER-phagy FAM134B calnexin autophagy rapamycin carbamazepine 4-PBA TUDCA chemical chaperone ISRIB ISR proteostasis UPR BMP-1 C-propeptide tafamidis kinetic stabilizer dominant-negative collagen XI rescue quality control' },
        ...
        { file: 'emerging/statins-triple-mechanism.html', title: 'Statins as Triple-Mechanism Therapy', k: 'statin HMG-CoA reductase isoprenoid Rho ROCK prenylation YAP NF-kB Wnt triple mechanism simvastatin pravastatin rosuvastatin pediatric repurposing disc MMP chondrocyte N-of-1 ferroptosis GPX4 lipophilic hydrophilic CoQ10 selenium tendinopathy' },
        { file: 'emerging/trpv4-blockade.html', title: 'TRPV4 Blockade: Breaking the Calcium-Iron Storm', k: 'TRPV4 GSK2798745 calcium iron ferroptosis Piezo1 mechanotransduction primary cilium ROS storm ion channel blocker antagonist skeletal dysplasia JCI Insight discontinued orphan drug GsMTx4 combination pain nociceptive central sensitization' },
        { file: 'emerging/complement-sump.html', title: 'The Complement Sump: Triple-Axis Inflammatory Amplifier', k: 'complement sump triple axis anaphylatoxin C3a C5a MAC avascular trap collagen IX NC4 shield loss C acnes biofilm collagen fragment DAMP MMP feed-forward mast cell tryptase cathepsin D non-canonical C5aR1 avacopan eculizumab doxycycline SDD circadian gating pain nerve ingrowth NGF NLRP3 sC5b-9 CH50 monitoring' },
        { file: 'emerging/senolytic-pulse.html', title: 'Senolytic Pulse Therapy', k: 'senolytic pulse therapy pediatric logic flip preventive dasatinib quercetin D+Q fisetin FOXO4-DRI navitoclax senescent cell clearance SASP p16 p21 progenitor sparing Mannarino 2025 Science Advances sparc SM/J Novais 2026 young genetically susceptible timing hypothesis disc cartilage' },
        { file: 'emerging/cx43-hemichannel-blockade.html', title: 'Cx43 Hemichannel Blockade', k: 'connexin-43 Cx43 hemichannel blockade tonabersat boldine mimetic peptides Gap19 dual-organ protection disc retina bone safety ATP release pannexin inflammasome NLRP3 gap junction bystander death NAD depletion avascular disc lens vitreous' },
        { file: 'emerging/interspecies-disc-biology.html', title: 'Interspecies Disc Biology', k: 'interspecies comparative biology notochordal cell persistence pig NCCM dog FGF4 FGFR3 zebrafish col11a1a axolotl regeneration naked mole-rat NRF2 vHMW-HA whale endplate space microgravity hibernation bear alpha-2-macroglobulin A2M omaveloxolone sulforaphane selenium roxadustat vosoritide HIF1alpha' },
        { file: 'emerging/immune-checkpoint-disc.html', title: 'Immune Checkpoint Biology in the Disc', k: 'immune checkpoint biology disc CD47 SIRPalpha FasL PD-L1 immune privilege macrophage M1 M2 polarization efferocytosis MerTK resolvin D1 RvD1 complement senescence TCC MAC CD59 clusterin avacopan dead cell clearance DAMP corpse problem adaptive immunity ferroptosis corpse Loop 9 transplant tolerance' },
        { file: 'emerging/precision-microbiome.html', title: 'Precision Microbiome Engineering', k: 'precision microbiome engineering gut-disc axis butyrate Faecalibacterium Roseburia Synlogic pharmabiome IPA indole-3-propionic acid urolithin A postbiotics metabolomics oral tolerance collagen fragments engineered bacteria DKK1 SFRP1 Wnt antagonist vitreous microbiome FMT' }
      ]
    }
  ];
